...
```
cd existing_repo
git remote add origin https://gitlab.com/cours8881444/openclassroom.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/cours8881444/openclassroom/-/settings/integrations)
